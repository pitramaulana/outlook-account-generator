...
def prompt_change_ip(should_beep):
    ...
    while True:
        ...
        if new_ip == current_ip:
            next_prompt = """In order to proceed, it is necessary to change your IP address as a precautionary measure against Bot Detection. Once you have successfully changed your IP address, please press Enter to continue..."""
